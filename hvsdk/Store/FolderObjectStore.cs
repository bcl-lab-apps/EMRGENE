...
{
    /// <summary>
    /// TODO: Implement encryption (optional?)
    /// Use the AppProvisionInfo.Secret as the encryption key
    /// The provision info itself is stored in the Windows password store
    /// </summary>
